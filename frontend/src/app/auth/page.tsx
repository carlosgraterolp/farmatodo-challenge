...
export default function Authentication() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl rounded-[32px] border border-neutral-200/50 bg-neutral-100 p-2 backdrop-blur-lg md:p-4 dark:border-neutral-700 dark:bg-neutral-800/50">
        {/* Caja que realmente usaremos para la colisión */}
        <div
          ref={containerRef}
...
const CollisionMechanism = React.forwardRef<HTMLDivElement, CollisionProps>(
