      ...
      <div className="mx-auto max-w-7xl items-start justify-between text-sm text-neutral-500 md:px-8">
        ...
        <div className="mt-8 flex w-full flex-col items-center justify-between sm:flex-row">
          <p className="mb-8 text-neutral-500 sm:mb-0 dark:text-neutral-400">
            &copy; {new Date().getFullYear()} Farma. Todos los derechos
            reservados.
          </p>
...
const Logo = () => {
  return (
    <Link
      href="/"
      className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-lg font-bold text-black dark:text-white cursor-pointer"
    >
      <IconPrescription className="text-2xl" />
      <span className="font-bold">Farma</span>
    </Link>
  );
};
